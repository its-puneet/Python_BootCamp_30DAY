...
lbl_open = tk.Label(fr_bg1, text="Please choose 2 or more PDFs to join")
lbl_open.grid(row=0, column=0, sticky="ew", padx=5, pady=5)

btn_open = tk.Button(fr_bg1, text="Open file",bg='black', fg='white',font=('Times New Roman', 12, 'bold') ,
...
btn_merge = tk.Button(fr_bg2,bg='black',font=('Times New Roman', 12, 'bold') ,
                text="Merge PDF",
                state="disabled",
...
btn_exit = tk.Button(window, text="Exit", command=window.destroy, bd=2, bg='black', fg='white',font=('Times New Roman', 12, 'bold') ,)
